...
function GameTest() {
    ...
    useEffect(() => {
        ...
        if (isMovementRunning) {
            ...
            if (finalData.length < MIN_POINTS) {
                ...
                setTimerDone(false);
                setFinalData("");
                console.log("Je fais un emit de 'MOUVEMENT_DONE' avec score = " + score);
    ...
    const choisirIDAleatoire = () => {
        const ids = ['BOD1', 'BOD2', 'BOD3', 'BOD4', 'BOD5', 'BOD6', 'BOD7', 'BOD8', 'HAN1', 'HAN2', 'HAN3', 'HAN4', 'HAN5'];
        const indexAleatoire = Math.floor(Math.random() * ids.length);
        setMovementRequiered(indexAleatoire);
        setTimerDone(false);
